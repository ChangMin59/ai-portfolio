...
저는 단순한 모델 구현을 넘어, **문제를 정의 → 데이터를 정제 → AI 모델링 → 서비스화 및 배포**까지  
전 과정을 주도적으로 경험했습니다.  
특히 **RAG 아키텍처, LLM 파인튜닝, 객체 탐지·추적, 맞춤형 QnA 시스템** 구축에 강점을 가지고 있습니다.  

본 저장소에는 대표 프로젝트와 포트폴리오 PDF가 포함되어 있으며,  
각 프로젝트는 **현실 문제 해결**을 목표로 설계·구현되었습니다.  
...
- **성과**:  
  ...
  - 
 ## 🔗 저장소
- **welhome 코드**: [welhome]([https://github.com/ChangMin59/Card_Chatbot](https://github.com/ChangMin59/welhome)
